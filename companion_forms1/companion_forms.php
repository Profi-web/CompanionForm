...
Author: Qreative Web
Version: 0.6.8
Author URI: http://qreative-web.com
License: GPL2
*/
...
add_action( 'wp_footer', 'add_styling' );
        ...
        <div class="tabcontents">
            ...
            if($progress == 0) {
            	echo"<div class='progressbar'>
        			<div style='width:".($width * $key)."%;' class='progress'><span style='left: ".($width * $key)."%; margin-left: -20px;'>".round($width * $key)."%</span></div>
        		</div>";
        	}
