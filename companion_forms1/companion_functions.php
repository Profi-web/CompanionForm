...
$cforms_db_version = '1.1';

function cforms_install($cforms_db_version){
  global $wpdb;
  $charset_collate = $wpdb->get_charset_collate();
	...
	$sql3 = "INSERT INTO $table_settings ( id, name, mail, sccsmsg, failmsg, navtab ) VALUES ( '1', 'Companion Form 1', 'mail@website.com', 'Mail was sent succesfully', 'Oops! Your mail hasnt been send', '0' )";
...
function cforms_steps() {
	...
	if (isset($_GET['editcform'])) {
		...
		echo '<div class="cforms_popup" style="position: fixed; background: #FFF; border-radius: 5px; box-shadow: 1px 1px 8px #424242; top: 250px; left: calc(50% - 125px); width: 250px; padding: 20px; z-index: 99999;">
		<b>You are about to delete something!</b><br>
		Are you sure?<br><br>
		<a href="admin.php?page=companionforms&true-delete='.$_GET['deletecform'].'" class="button button-primary">Yes!</a>
		&nbsp;&nbsp;<a href="admin.php?page=companionforms" class="button">Neh</a>
		</div>';
}
...
function register_cforms_menu_page(){
	add_menu_page( 'Companion Forms', 'Companion Forms', 'manage_options', 'companionforms', 'cforms_menu_page', 'dashicons-welcome-write-blog', 6 );
