...
if( isset( $_POST['submit'] ) ) {
	...
	if( isset( $_POST["submit_google"] ) ) $submit_google = $_POST["submit_google"]; else $submit_google = '';
	if( isset( $_POST["submit_bing"] ) ) $submit_bing = sanitize_text_field( $_POST['submit_bing'] ); else $submit_bing = '';
...
<div class="csg-column-wide">
	...
	<?php if( csg_incorrectDatabaseVersion() ) { ?>
		<div class="welcome-to-csg welcome-panel gutenberg-bg csg-dashboard-box">
	...
	<div class="welcome-to-csg welcome-panel welcome-bg csg-dashboard-box">
		...
		<form method="POST">
			<p>
				...
				<a href='<?php echo csg_sitemap_url(); ?>' target='_blank' class='button button-primary'><?php _e('View sitemap', 'companion-sitemap-generator'); ?></a>
	...
	<div class="welcome-to-csg welcome-panel submit-bg csg-dashboard-box">
			...
			<div class='welcome-column welcome-column-half'>
				...
				<p>
					<label for="submit_google"><input type="checkbox" id="submit_google" name="submit_google" <?php if( csg_notify_engine( 'google' ) ) { echo "CHECKED"; } ?> > <?php echo sprintf( esc_html__( 'Notify %s', 'companion-sitemap-generator' ), 'Google' ); ?></label>&nbsp;&nbsp;
				</p>
				<p>
					<label for="submit_bing"><input type="checkbox" id="submit_bing" name="submit_bing" <?php if( csg_notify_engine( 'bing' ) ) { echo "CHECKED"; } ?> > <?php echo sprintf( esc_html__( 'Notify %s', 'companion-sitemap-generator' ), 'Bing' ); ?></label>
				</p>
		...
		<div class="welcome-to-csg welcome-panel settings-bg csg-dashboard-box">

			<div class='welcome-column welcome-column-third'>
			...
			</div><div class='welcome-column welcome-column-third'>
	...
	<div class="welcome-to-csg welcome-panel robots-bg csg-dashboard-box">
		...
		<?php if( csg_has_robots() ) {
			...
			<div class='welcome-column welcome-column-half'>
				...
				<br />
				<form method="POST">
					<textarea name="csg_robots_content" rows="10" cols="50"><?php csg_read_robots(); ?></textarea>
	...
	<div class="welcome-to-csg help-bg welcome-panel csg-dashboard-box">
	...
	<div class="welcome-to-csg support-bg welcome-panel csg-dashboard-box">
	...
	<div class="welcome-to-csg love-bg csg-show-love welcome-panel csg-dashboard-box">
		...
		<a href="https://wordpress.org/support/plugin/companion-sitemap-generator/reviews/#new-post" target="_blank" class="button button-alt button-hero">
			<?php _e('Rate us (5 stars?)', 'companion-sitemap-generator'); ?>
		</a>
		<a href="<?php echo csg_donateUrl(); ?>" target="_blank" class="button button-primary button-hero">
